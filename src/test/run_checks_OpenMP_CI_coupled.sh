...
$MYPATH/b2diff.py --tolerance 0.01 --maxerr 'te ti na ni ne po' --specific-tolerance 'fhe 0.10 fhe_eir 0.05 fhep 0.05 fhe0 0.05 fhe_mdf 0.10 fhi 0.10 fhi_eir 0.05 fhi_mdf 0.10 fhi0 0.025 fhip 0.025 fhit 0.05 fhet 0.10 fht 0.05 floe_noc 0.15 floi_noc 0.15 fna 0.05 fna_fcor 0.05 fna_mdf 0.05 fna_nodrift 0.05 fnap 0.25 fni 0.25 fni_32 0.25 te 0.1 ti 0.2 po 0.1 pop 0.1 ne2 0.02 cdkt 0.05 chce 0.25 chci 0.10 chvemx 0.05 chvimx 0.02 cvsa 0.025 cvsa_cl 0.025 hce0 0.25 hci0 0.25' -i 'time|data|b2stb*|res*|del*|sm*|po0|na*|ne0|nep|ni0|ua*|kinrgy|fna0|fna_he|fna_32|fna_52|fna_eir|fne|fne_32|fne_52|fne_eir|fni_52|fch*|fhj|fhp|fhm|fmo|rcx*|rra*|rsa*|alf*|calf*|cdpa|csig*|dpa*|fllim*|rqahe|rqbrm|rqrad|b2sihs_*|b2npmo_sm*' -v compare_results.log
