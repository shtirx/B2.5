...
!     for adjoint AD to avoid side-effect variables
  ...
  USE B2US_FEEDBACK_DIFFV, ONLY : she_rad_tot
  USE B2MOD_DIFFSIZES
  IMPLICIT NONE
...
!.specification
!
SUBROUTINE B2STEL_DV(ncv, nfc, ns, ismain, switch, geo, mpg, pl, pld, dv&
& , dvd, rt, rtd, rtw, rtwd, srw, srwd, nbdirs)
  USE B2MOD_TYPES
  USE B2MOD_DIAG_DIFFV
  USE B2MOD_TALLIES
  USE B2MOD_CONSTANTS
...
!     for adjoint AD to avoid side-effect variables
  ...
  USE B2MOD_SUBSYS
  USE B2MOD_DIMENSIONS
  USE B2US_FEEDBACK_DIFFV, ONLY : she_rad_tot, she_rad_totd
