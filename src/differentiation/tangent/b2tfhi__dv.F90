...
!
!srv 16.10.17
  CALL B2TIPSCH_DV(ncv, nfc, nvx, ns, switch, geo, geod, mpg, mpgd, dv%&
&            facdrift, co%cddi, cod%cddi, pl%ti, pld%ti, pl%na, pld%na, &
&            dv%floi, dvd%floi, dv%coni, dvd%coni, dv%fhipsch, dvd%&
&            fhipsch, nbdirs)
!
  wght = 1.0_R8
!srv 25.01.02 {
