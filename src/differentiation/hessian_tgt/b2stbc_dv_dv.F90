...
!                *(dvd.fna_eir) *(dvd.fhe) *(dvd.fhepsch) *(dvd.fhi)
...
!                st_ext.am:in st_ext.za:in st_ext.na:in st_ext.ta:in
...
!                pld.zt:in pl.na:in pl.ua:in pl.po:in pl.te:in
!                pl.ti:in pl.tn:in pl.kt:in pl.zt:in psncd.na:in
...
&     COMPUTE_FEEDBACK_DV_DV(ncv, nfc, ns, ismain, switch, geo, mpg, pl&
&                      , pld0, pld, pldd, dv, dvd0, dvd, dvdd, rt, rtd0&
&                      , rtd, rtdd, psnc, psncd0, psncd, psncdd, psnl, &
&                      psnld0, psnld, psnldd, main_call, nbdirs, nbdirs0&
&                     )
!
