...
& , read_b2fplasma, write_b2fplasma
  PUBLIC :: read_b2fgmtry_dv0, read_b2fstate_dv0
...
!                gm.ftconn:in-out gm.fsconn:in-out gm.fteps:in-out
!                gm.ftbbav2:in-out gm.ftfpsi:in-out gm.fspsi:in-out
!                gm.ftds:out gm.fsds:out mpg.intcellp:in-out mpg.intcellr:in-out
!                mpg.divfcor:in-out
!
!**********************************************************************
...
!**********************************************************************
!
  SUBROUTINE READ_B2FGMTRY_DV0(ninp, mpg, gm, gmd, nbdirs)
    USE B2MOD_DIFFSIZES
!  Hint: nbdirsmax0 should be the maximum number of differentiation directions
    IMPLICIT NONE
    INTEGER, INTENT(IN) :: ninp
...
!
    ...
    CALL READ_GEOMETRY_DV0(ninp, mpg%ncv, mpg%nfc, mpg%nvx, mpg%nfs, mpg&
&                    %nft, mpg%nvmxcv, gm, gmd, nbdirs)
!
    RETURN
  END SUBROUTINE READ_B2FGMTRY_DV0
