...
!.specification
!
SUBROUTINE B2RUCP_NODIFF_NODIFF(nget, version, ns)
  USE B2MOD_TYPES
  USE B2MOD_CONSTANTS
...
!   ..procedures
  ...
  EXTERNAL B2XVCP_NODIFF_NODIFF, B2RUZD_NODIFF_NODIFF
  INTEGER :: arg1
!
!-----------------------------------------------------------------------
!.computation
...
! ..read common blocks
!   ..read /b2cmpa/
  CALL B2RUZD_NODIFF_NODIFF(nget, version, ns, zamin, zamax, zn, am, &
&                     .true.)
!   ..read /b2cmpb/
  idum = 0
...
! ..return
  CALL SUBEND()
  RETURN
END SUBROUTINE B2RUCP_NODIFF_NODIFF
