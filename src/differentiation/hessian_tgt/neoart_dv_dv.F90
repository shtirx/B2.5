...
!
!
SUBROUTINE NEOART_NODIFF_NODIFF(nsp, ncs, nsd, nzd, zzs, msp, t, den, ds&
& , rho, epsn, nreg, sigma, nleg, nenergy, ncof, neogeo, neofrc, ic, &
& eparr, coeff)
!--------------------------------------------------------------------
...
!
  ...
  USE B2MOD_RANGES
  USE B2MOD_CONSTANTS
  USE B2MOD_NEOCLASSICAL_DIFFV_DIFFV
  USE B2MOD_DIFFSIZES
  IMPLICIT NONE
!
...
!
  RETURN
END SUBROUTINE NEOART_NODIFF_NODIFF
