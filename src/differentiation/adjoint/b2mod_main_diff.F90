...
!
    CALL B2MNDR_0_B(ninp, nout, ns, nsb, ns0)
!
    RETURN
...
!
  SUBROUTINE B2MN_FIN_B()
    IMPLICIT NONE
    INTEGER :: io
    INTRINSIC SIZE
!
    CALL B2MNDR_2_B(nout, ns)
!   ..close files
    DO io=0,SIZE(ninp)-1
