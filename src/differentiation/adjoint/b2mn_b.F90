...
PROGRAM B2MN_B
  USE B2MOD_TYPES
  USE B2MOD_MAIN_DIFF, ONLY : b2mn_init, b2mn_init_b, b2mn_step, &
& b2mn_step_b, b2mn_fin, b2mn_fin_b
  USE B2MOD_AD_DIFF, ONLY : nncf
  USE B2MOD_PAR_OPT_DIFF, ONLY : npar_opt, nsigma_opt, nmean_opt, &
& nshift_opt, ncorr_opt, par_opt_phys, par_opt_physb
  USE B2US_DATA_DIFF
  IMPLICIT NONE
  REAL(kind=r8) :: j(nncf)
...
&            , state_ext, state_extb, state_avg, state_avgb, j, jb)
  CALL B2MN_FIN_B(switch, geo, geob, mpg, mpgb, state, stateb, state_ext&
&           , state_extb, state_avg, state_avgb)
!
  STOP
!
!-----------------------------------------------------------------------
...
SUBROUTINE B2MN_NODIFF()
  USE B2MOD_TYPES
  USE B2MOD_MAIN_DIFF, ONLY : b2mn_init, b2mn_step, b2mn_fin
  USE B2MOD_AD_DIFF, ONLY : nncf
  USE B2MOD_PAR_OPT_DIFF, ONLY : npar_opt, nsigma_opt, nmean_opt, &
