...
& facvis_tanh_a, facvis_tanh_b
  REAL(kind=r8) :: fac_exb_scalarb, fac_vis_scalarb
...
&     fac_vis_scalar, facvis_tanh_a, facvis_tanh_b
  SAVE fac_exb_scalarb, fac_vis_scalarb
