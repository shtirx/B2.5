      ...
      DO spec=ns-1,0,-1
        DO kind_data=nkind_data,1,-1
          ...
          IF (branch .NE. 0) THEN
            ...
            DO is=ad_to1,1,-1
              DO 120 icv=mpg%ncv,mpg%nci+1,-1
...
&                       /temp
                      ...
                      rtb%rza(icv, nsp(is)) = rtb%rza(icv, nsp(is)) + pl&
&                       %te(icv)*tempb0
...
&                       poloidal_scale_factor*hcibb(icv, nsp(is))
                      plb%na(icv, nsp(is)) = plb%na(icv, nsp(is)) + prof&
&                       (iy2)*poloidal_scale_factor*hcibb(icv, nsp(is))
...
&                     vla0b(icv, 1, nsp(is))
                ...
                ELSE IF (branch .LT. 10) THEN
                  IF (branch .EQ. 7) THEN
                    poloidal_scale_factor = 1.0_R8
                    tempb1 = poloidal_scale_factor*mp*am(nsp(is))*vsa0b(&
&                     icv, nsp(is))
                    vsa0b(icv, nsp(is)) = 0.D0
                    profb(iy2) = profb(iy2) + pl%na(icv, nsp(is))*tempb1
                    plb%na(icv, nsp(is)) = plb%na(icv, nsp(is)) + prof(&
&                     iy2)*tempb1
...
&                       - temp1*prof(iy2)*dv%ne(icv)*tempb1/(pl%te(icv)*&
&                       2.0*temp0)
                  END IF
...
&                       vla0b(icv, 1, nsp(is))
                  ...
                  ELSE IF (branch .LT. 9) THEN
                    IF (branch .EQ. 6) THEN
                      poloidal_scale_factor = 1.0_R8
                      tempb = poloidal_scale_factor*mp*am(nsp(is))*vsa0b&
&                       (icv, nsp(is))
                      vsa0b(icv, nsp(is)) = 0.D0
                      profb(iy2) = profb(iy2) + pl%na(icv, nsp(is))*&
&                       tempb
...
&                       (iy2)*tempb
                    ELSE IF (branch .EQ. 7) THEN
                      ...
                      dvb%ne(icv) = dvb%ne(icv) + prof(iy2)*tempb
                    ELSE
                      poloidal_scale_factor = 1.0_R8
                      tempb = qe*poloidal_scale_factor*sig0b(icv)
                      sig0b(icv) = 0.D0
                      profb(iy2) = profb(iy2) + dv%ne(omp(1))*tempb
                      dvb%ne(omp(1)) = dvb%ne(omp(1)) + prof(iy2)*tempb
                    END IF
                  ELSE IF (branch .LT. 11) THEN
                    IF (branch .NE. 9) THEN
                      ...
                      alf0b(icv) = 0.D0
                      profb(iy2) = profb(iy2) + dv%ne(icv)*temp2*tempb
                      dvb%ne(icv) = dvb%ne(icv) + prof(iy2)*temp2*tempb
                      IF (.NOT.temp1 .EQ. 0.D0) plb%te(icv) = plb%te(icv&
&                         ) - temp1*prof(iy2)*dv%ne(icv)*tempb/(pl%te(&
&                         icv)*2.0*temp2)
                    END IF
